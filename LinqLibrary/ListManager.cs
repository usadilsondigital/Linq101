...
namespace LinqLibrary
{
  public class ListManager
  {
    public static List<Person> LoadSampleData()
    {
      ...
      output.Add(new Person { FirstName = "Pedro", LastName = "Paramo", Birthday = Convert.ToDateTime("2/25/1970"), YearsExperience = 20 });
      ...
      output.Add(new Person { FirstName = "Sara", LastName = "Gomez", Birthday = Convert.ToDateTime("3/6/1970"), YearsExperience = 8 });
